...
void game (HDC cube, HDC circle, HDC shadow)
    ...
    Object geometry [] = { {szX (50), szY (50), 1, 1, 2,  circle, 81, 76, Type_circle},
                           {szX (8),  szY (8),  1, 9, 10, cube,   70, 70, Type_cube},
                           {szX (92), szY (92), 1, 9, 10, cube,   70, 70, Type_cube},
                           {szX (92), szY (8),  1, 9, 10, cube,   70, 70, Type_cube},
                           {szX (8),  szY (92), 1, 9, 10, cube,   70, 70, Type_cube} };
